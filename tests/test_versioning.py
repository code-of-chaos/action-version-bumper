...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("1.2.3-preview.5", "patch", "1.2.4"),
        ("1.2.3-preview.5", "minor", "1.3.0"),
        ("1.2.3-preview.5", "major", "2.0.0"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("1.2.3-BETA.5", "patch", "BETA", "1.2.4"),
        ("1.2.3-BETA.5", "minor", "BETA", "1.3.0"),
        ("1.2.3-BETA.5", "major", "BETA", "2.0.0"),
